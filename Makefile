...
COMPILE_FLAGS_COMMON = -DVULKAN_HPP_NO_CONSTRUCTORS -DVULKAN_HPP_NO_STRUCT_CONSTRUCTORS -DVULKAN_HPP_HANDLE_ERROR_OUT_OF_DATE_AS_SUCCESS -DGLFW_INCLUDE_VULKAN -DGLM_FORCE_RADIANS -DSTB_IMAGE_IMPLEMENTATION
